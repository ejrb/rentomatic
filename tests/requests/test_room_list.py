...
def test_build_room_list_with_invalid_filters_parameter():
...
def test_build_room_list_with_invalid_filters_key():
...
def test_build_room_list_request_accepted_numeric_filters(key):
    filters = {key: 1}
